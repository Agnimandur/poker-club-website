<script>
	...
	const tournaments = ["Fall 2023 Tournament Winner", "2023 Heads Up Tournament Winner", "Xuan Liu Tournament Winner", "Citadel Tournament Winner", "2022 Tournament Winner"]
	const winners = ["Anthony Jiang", "Allen Yang","Nadim Motaghedi","Derek Wong","Ryan Driscoll"];
...
<div class="section">
	...
	<div class="row-uneven">
		<div class="col">
			...
			<p>
				Poker Club generally hosts one tournament a semester. These club sponsored tournaments usually have a buyin of $20, with a prizepool consisting of both club funds and member buyins. We guaranteed $5000 in our Feb 2023 tournament with Xuan Liu!
			</p>
			<br />
